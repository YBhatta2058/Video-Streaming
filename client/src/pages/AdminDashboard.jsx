...
import UploadTweetModal from "../components/uploadTweetModal";
...
const AdminDashboard = () => {
  ...
  const [uploadTweetModal,setUploadTweetModal] = useState(false);
        ...
        <section className="p-3 w-full flex flex-col justify-start gap-4 overflow-x-hidden overflow-y-auto">
          <div className="w-full flex items-center justify-between gap-2">
            ...
            <Button
              ...
              onClick={() => setUploadTweetModal(true)}>
              <ArrowUpTrayIcon className="w-5 h-5" />
              <span>Upload Tweet</span>
            </Button>
            <Button
              className="flex items-center gap-1 sm:gap-2 text-xs sm:text-base"
...
{uploadTweetModal && (
            <UploadTweetModal setUploadTweetModal={setUploadTweetModal} />
          )}
